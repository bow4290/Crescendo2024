...
public class Shooter extends SubsystemBase {
  ...
  public static final int INDEXER_BUTTON_DIO_PORT = 0;
  ...
  private static DigitalInput indexerButton = new DigitalInput(INDEXER_BUTTON_DIO_PORT);
  public static Trigger indexerTrigger = new Trigger(indexerButton::get);
